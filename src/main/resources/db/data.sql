...
--
-- IMPORTANTE: sustituir los hashes __HASH_X__ por los generados con
--   es.uji.ei1027.sgovi.util.GenerarHashes antes de aplicar.
-- =====================================================================
...
-- Usuarios OVI (uno aceptado, otro pendiente)
...
INSERT INTO asistentepersonal (id_ap, dni, nombre, apellidos, email, telefono, tipo_ap, formacion, experiencia, disponibilidad, latitud, longitud, consentimiento_lopd, estado) VALUES
                                                                                                                                                                                    ('ap_marta01', '44444444D', 'Marta', 'Lopez Sanchez', 'marta.lopez@test',  '600444444', 'PAP',  'Grado en Trabajo Social',  '3 anyos en residencias',          'Mananas L-V', 39.9864, -0.0513, TRUE, 'aceptado'),
                                                                                                                                                                                    ('ap_jorge02', '55555555E', 'Jorge', 'Ruiz Vidal',    'jorge.ruiz@test',   '600555555', 'PATI', 'Tecnico en Atencion Infantil', '1 anyo en centro educativo', 'Tardes L-V', 39.9700, -0.0400, TRUE, 'pendiente');
